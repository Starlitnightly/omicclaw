        ...
        const dict = {
            en: {
                ...
                , 'gateway.discord.tokenHint': 'Get from Discord Developer Portal — set DISCORD_BOT_TOKEN env var or enter here'
                 , 'gateway.wechat.token': 'iLink Bot Token'
                , 'gateway.wechat.tokenHint': 'Get from Tencent WeChat iLink / ClawBot login flow, or set WECHAT_BOT_TOKEN'
                , 'gateway.wechat.baseUrl': 'iLink Base URL'
                , 'gateway.wechat.baseUrlHint': 'Default is the official Tencent iLink endpoint'
                , 'gateway.wechat.allowFrom': 'Allow From <span class="text-muted fw-normal">(comma-sep user IDs)</span>'
                , 'gateway.wechat.allowFromHint': 'Leave empty to allow all direct-message senders'
                , 'gateway.wechat.loginButton': 'Fetch QR code'
                , 'gateway.wechat.loginFetching': 'Requesting QR...'
                , 'gateway.wechat.loginTitle': 'WeChat login'
                , 'gateway.wechat.loginPrompt': 'Use WeChat to scan the QR code'
                , 'gateway.wechat.loginScanning': 'Scanning...'
                , 'gateway.wechat.loginHint': 'Keep this window open until the token appears'
                , 'gateway.wechat.loginError': 'Login failed — please retry'
                , 'gateway.wechat.loginStatus': 'Status: {status}'
                , 'gateway.wechat.loginSuccess': 'Token captured — save the config to persist it'
                ...
                , 'gateway.testFailed': 'API Key Test Failed'
                , 'gateway.keyValid': 'API key is valid ✓'
            ...
            zh: {
                ...
                , 'gateway.wechat.token': 'iLink Bot Token'
                , 'gateway.wechat.tokenHint': '从腾讯微信 iLink / ClawBot 登录流程获取，也可通过 WECHAT_BOT_TOKEN 环境变量设置'
                , 'gateway.wechat.baseUrl': 'iLink Base URL'
                , 'gateway.wechat.baseUrlHint': '默认使用腾讯官方 iLink 接口地址'
                , 'gateway.wechat.allowFrom': '允许的用户 <span class="text-muted fw-normal">（逗号分隔 user ID）</span>'
                , 'gateway.wechat.allowFromHint': '留空表示允许所有私聊发送者'
                , 'gateway.wechat.loginButton': '获取登录二维码'
                , 'gateway.wechat.loginFetching': '正在请求二维码...'
                , 'gateway.wechat.loginTitle': 'WeChat 登录'
                , 'gateway.wechat.loginPrompt': '请用微信扫描二维码'
                , 'gateway.wechat.loginScanning': '等待扫码...'
                , 'gateway.wechat.loginHint': '扫码后保持此页即可自动完成'
                , 'gateway.wechat.loginError': '登录失败，请重试'
                , 'gateway.wechat.loginStatus': '状态: {status}'
                , 'gateway.wechat.loginSuccess': 'Token 已捕获，保存配置即可生效'
                , 'gateway.feishu.appId': 'App ID'
                , 'gateway.feishu.appSecret': 'App Secret'
                ...
                , 'gateway.testFailed': 'API Key 校验失败'
                , 'gateway.keyValid': 'API Key 有效 ✓'
                , 'gateway.temperature': 'Temperature'
                , 'gateway.topP': 'Top P'
                ...
                , 'gateway.channel.telegram': 'Telegram'
                , 'gateway.channel.discord': 'Discord'
                , 'gateway.channel.wechat': '微信 / WeChat'
